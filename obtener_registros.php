<?php
    ...
    // Conexion con los dos elementos php
    ...
    // Buscar por el valor de Nombre o Apellidos
    ...
    // Ordenar por el nombre o por su defecto por el ID
    ...
    // Obtener la longitud de la base datos
    if($_POST["length"] != -1){
    ...
    foreach($resultado as $fila){
        ...
        // Conexion con cada subcampo de la tabla mediante un subarray
        $sub_array = array();
        $sub_array[] = $fila["id"];
        $sub_array[] = $fila["nombre"];
        $sub_array[] = $fila["apellidos"];
        $sub_array[] = $fila["documento"];
